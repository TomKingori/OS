...
.loop:
    ...
    jz .done            ; jumps to destinatiom in zero flag is set
...
main:
    ...
    mo bx, 0x7E00       ; data should be after the bootloader
    call disk_read
...
disk_read:
    ...
    pop ax                              ; AL = number od sectors to read
